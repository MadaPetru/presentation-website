...
!function (e, t) {
  ...
  class p {
    ...
    init() {
      const e = this, t = {position: "absolute", top: 0, left: 0, width: "100%", height: "100%", overflow: "hidden"};
      let o = {
        pointerEvents: "none",
    ...
    coverImage() {
      ...
      return n && (0 > o ? (a = o * Math.max(i, s), s < i && (a -= o * (i - s))) : a = o * (i + s), 1 < o ? l = Math.abs(a - s) : 0 > o ? l = a / o + Math.abs(a) : l += (s - i) * (1 - o), a /= 2), e.parallaxScrollDistance = a, r = n ? (s - l) / 2 : (i - l) / 2, e.css(e.image.$item, {
        ...
        width: `${t.width}px`
      }), e.options.onCoverImage && e.options.onCoverImage.call(e), {image: {height: l, marginTop: r}, container: t}
    }
  ...
  class o {
    ...
    attachListeners() {
      ...
      this.off(s, "click.chocolat"), this.on(s, "click.chocolat", () => {
        ...
        const t = this.elems.wrapper.getBoundingClientRect(), s = t.top + window.scrollY, i = t.left + window.scrollX,
          l = this.elems.wrapper.clientHeight, n = this.elems.wrapper.clientWidth, a = this.elems.img.width,
          o = this.elems.img.height, c = [e.pageX - n / 2 - i, e.pageY - l / 2 - s];
        let h = 0;
        if (a > n) {
  ...
  return function (e) {
    ...
    function n(e, t) {
      var n = window.document,
        r = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, a = new r(o);
...
var Swiper = function () {
  ...
  function C(e) {
    return void 0 === e && (e = {}), S || (S = function (e) {
      ...
      const s = M(), a = r(), i = a.navigator.platform, n = t || a.navigator.userAgent, l = {ios: !1, android: !1},
        ...
        if (z = 0, u[i] && (r = u[i]), L && e.grid.updateSlide(i, r, m, t), !u[i] || "none" !== v(r, "display")) {
          if ("auto" === a.slidesPerView) {
            ...
            if (l && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), a.roundLengths) z = e.isHorizontal() ? E(r, "width", !0) : E(r, "height", !0); else {
              const e = s(n, "width"), t = s(n, "padding-left"), a = s(n, "padding-right"), i = s(n, "margin-left"),
                l = s(n, "margin-right"), o = n.getPropertyValue("box-sizing");
  ...
  const ce = [function (e) {
    ...
    let d, c, p, u, m, h, f, g = o && o.autoplay ? o.autoplay.delay : 3e3, v = o && o.autoplay ? o.autoplay.delay : 3e3,
      w = (new Date).getTime;
      ...
      setTranslate: () => {
        ...
        for (let s = 0; s < e.length; s += 1) {
          ...
          const g = u.join(", "), v = `rotateX(${m[0]}deg) rotateY(${m[1]}deg) rotateZ(${m[2]}deg)`,
            ...
            b = c < 0 ? 1 + (1 - f.opacity) * c * n : 1 - (1 - f.opacity) * c * n, y = `translate3d(${g}) ${v} ${w}`;
          if (h && f.shadow || !h) {
